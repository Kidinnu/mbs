...
p.pw{1} = @(q,dq) [cos(q(2))*sin(q(3))*dq(2)+cos(q(3))*sin(q(2))*dq(3);
                   cos(q(2))*cos(q(3))*dq(2)-sin(q(3))*sin(q(2))*dq(3);
                   -sin(q(2))*q(2)]+[-sin(q(3));-cos(q(3));0]*dq(3);
p.pw{2} = @(q,dq) [0;cos(q(2))*dq(2);-sin(q(2))*q(2)]; 
p.pw{3} = @(q,dq) [0;0;0]; 
% =========================================================================
% Preprocessing
% =========================================================================
...
[t, q] = ode113(@(t,q) dqdt(t,q,p), [0 2], q0);
fprintf('OK\n');
%% =========================================================================
% Postprocessing
% =========================================================================
